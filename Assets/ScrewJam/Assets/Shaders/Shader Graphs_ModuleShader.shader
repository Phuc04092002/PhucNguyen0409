...
Shader "Shader Graphs/ModuleShader"
{
  Properties
  {
    [NoScaleOffset] _MainTex ("MainTex", 2D) = "white" {}
    [NoScaleOffset] _MaskTex ("MaskTex", 2D) = "white" {}
    _MainColor ("MaskColor", Color) = (1,0,0,1)
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Sprite Lit
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = texture(_MaskTex, in_f.vs_INTERP1.xy, _GlobalMipBias.x);
          
          u_xlat16_1 = texture(_MainTex, in_f.vs_INTERP1.xy, _GlobalMipBias.x);
          
          u_xlat2.xyz = u_xlat16_0.xyz * _MainColor.xyz;
          
          u_xlatb3.xyz = lessThan(u_xlat2.xyzx, float4(0.5, 0.5, 0.5, 0.0)).xyz;
          
          u_xlat2.xyz = u_xlat2.xyz * float3(2.0, 2.0, 2.0) + u_xlat16_1.xyz;
          
          u_xlat2.xyz = u_xlat2.xyz + float3(-1.0, -1.0, -1.0);
          
          u_xlat2.xyz = max(u_xlat2.xyz, float3(0.0, 0.0, 0.0));
          
          u_xlat0_d.xyz = u_xlat16_0.xyz * _MainColor.xyz + float3(-0.5, -0.5, -0.5);
          
          u_xlat0_d.xyz = u_xlat0_d.xyz * float3(2.0, 2.0, 2.0) + u_xlat16_1.xyz;
          
          u_xlat0_d.xyz = min(u_xlat0_d.xyz, float3(1.0, 1.0, 1.0));
              ...
              hlslcc_movcTemp.x = (u_xlatb3.x) ? u_xlat2.x : u_xlat0_d.x;
              
              hlslcc_movcTemp.y = (u_xlatb3.y) ? u_xlat2.y : u_xlat0_d.y;
              
              hlslcc_movcTemp.z = (u_xlatb3.z) ? u_xlat2.z : u_xlat0_d.z;
              
              u_xlat0_d = hlslcc_movcTemp;
      
      }
          
          u_xlat2.x = (-u_xlat16_0.w) + 1.0;
          
          u_xlat2.xyz = u_xlat16_1.xyz * u_xlat2.xxx;
          
          u_xlat16_1.xyz = u_xlat16_0.www * u_xlat0_d.xyz + u_xlat2.xyz;
    ...
    Pass // ind: 3, name: Sprite Forward
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = u_xlat16_0.xyz * _MainColor.xyz;
          
          u_xlat16_2 = texture(_MainTex, in_f.vs_INTERP1.xy, _GlobalMipBias.x);
          
          u_xlat3.xyz = u_xlat1_d.xyz * float3(2.0, 2.0, 2.0) + u_xlat16_2.xyz;
          
          u_xlatb1.xyz = lessThan(u_xlat1_d.xyzx, float4(0.5, 0.5, 0.5, 0.0)).xyz;
          ...
          u_xlat0_d.xyz = u_xlat0_d.xyz * float3(2.0, 2.0, 2.0) + u_xlat16_2.xyz;
          ...
          u_xlat0_d.xyz = min(u_xlat0_d.xyz, float3(1.0, 1.0, 1.0));
              ...
              hlslcc_movcTemp.x = (u_xlatb1.x) ? u_xlat3.x : u_xlat0_d.x;
              
              hlslcc_movcTemp.y = (u_xlatb1.y) ? u_xlat3.y : u_xlat0_d.y;
              
              hlslcc_movcTemp.z = (u_xlatb1.z) ? u_xlat3.z : u_xlat0_d.z;
              
              u_xlat0_d = hlslcc_movcTemp;
      
      }
          
          u_xlat1_d.x = (-u_xlat16_0.w) + 1.0;
          
          u_xlat1_d.xyz = u_xlat16_2.xyz * u_xlat1_d.xxx;
          
          u_xlat16_2.xyz = u_xlat16_0.www * u_xlat0_d.xyz + u_xlat1_d.xyz;
          
          u_xlat0_d = u_xlat16_2 * in_f.vs_INTERP2;
