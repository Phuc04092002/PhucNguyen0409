...
Shader "Universal Render Pipeline/2D/Sprite-Lit-Default"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      // m_ProgramMask = 6
      CGPROGRAM
      #pragma multi_compile unity_LODFade unity_WorldTransformParams unity_RenderingLayer unity_LightData
      //#pragma target 4.0
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = texture(_MainTex, in_f.texcoord.xy, _GlobalMipBias.x);
          ...
          if(u_xlatb1)
      {
          ...
          u_xlat16_1 = texture(_MaskTex, in_f.texcoord.xy, _GlobalMipBias.x);
          
          u_xlat2.xyz = texture(_ShapeLightTexture0, in_f.texcoord1.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat2.xyz = texture(_ShapeLightTexture1, in_f.texcoord1.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat2.xyz = texture(_ShapeLightTexture2, in_f.texcoord1.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat2.xyz = texture(_ShapeLightTexture3, in_f.texcoord1.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat16_3.xyz = u_xlat0_d.xyz * u_xlat16_6.xyz + u_xlat16_3.xyz;
          
          u_xlat16_1.xyz = float3(_HDREmulationScale) * u_xlat16_3.xyz + (-u_xlat0_d.xyz);
          
          u_xlat16_1.w = 0.0;
          
          u_xlat16_0 = float4(float4(_UseSceneLighting, _UseSceneLighting, _UseSceneLighting, _UseSceneLighting)) * u_xlat16_1 + u_xlat0_d;
    ...
    Pass // ind: 2, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord.xy = in_v.texcoord.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.x = in_f.texcoord2.x;
          
          u_xlat16_0.y = in_f.texcoord3.x;
          
          u_xlat16_0.z = in_f.texcoord1.x;
          
          u_xlat16_1.xyz = texture(_NormalMap, in_f.texcoord.xy, _GlobalMipBias.x).xyz;
          
          u_xlat16_2_d.xyz = u_xlat16_1.xyz * float3(2.0, 2.0, 2.0) + float3(-1.0, -1.0, -1.0);
          
          u_xlat1_d.x = dot(u_xlat16_2_d.xyz, u_xlat16_0.xyz);
          
          u_xlat16_0.x = in_f.texcoord2.y;
          
          u_xlat16_0.y = in_f.texcoord3.y;
          
          u_xlat16_0.z = in_f.texcoord1.y;
          
          u_xlat1_d.y = dot(u_xlat16_2_d.xyz, u_xlat16_0.xyz);
          
          u_xlat16_0.x = in_f.texcoord2.z;
          
          u_xlat16_0.y = in_f.texcoord3.z;
          
          u_xlat16_0.z = in_f.texcoord1.z;
          
          u_xlat1_d.z = dot(u_xlat16_2_d.xyz, u_xlat16_0.xyz);
          
          u_xlat16_0.xyz = u_xlat1_d.xyz + float3(1.0, 1.0, 1.0);
          
          out_f.color.xyz = u_xlat16_0.xyz * float3(0.5, 0.5, 0.5);
          
          u_xlat16_1.x = texture(_MainTex, in_f.texcoord.xy, _GlobalMipBias.x).w;
          
          u_xlat1_d.x = u_xlat16_1.x * in_f.color.w;
    ...
    Pass // ind: 3, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.color = u_xlat0 * _RendererColor;
