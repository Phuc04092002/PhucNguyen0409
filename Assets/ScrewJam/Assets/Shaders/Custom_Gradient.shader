  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Default
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat16_0 = (-_StartColor) + _EndColor;
          
          out_v.color = u_xlat16_0 * float4(0.5, 0.5, 0.5, 0.5) + _StartColor;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = _StartColor + (-_EndColor);
          
          u_xlat0_d = in_f.texcoord.yyyy * u_xlat0_d + _EndColor;
