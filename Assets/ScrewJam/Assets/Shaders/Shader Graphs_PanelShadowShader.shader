...
Shader "Shader Graphs/PanelShadowShader"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Sprite Lit
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = texture(_MainTex, in_f.vs_INTERP1.xy, _GlobalMipBias.x).w;
          
          u_xlat0_d.x = u_xlat16_0 * _MainColor.w;
          
          u_xlat0_d.w = u_xlat0_d.x * in_f.vs_INTERP2.w;
          ...
          if(u_xlatb1)
      {
          ...
          u_xlat0_d.xyz = in_f.vs_INTERP2.xyz * _MainColor.xyz;
    ...
    Pass // ind: 2, name: Sprite Normal
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = texture(_MainTex, in_f.vs_INTERP2.xy, _GlobalMipBias.x).w;
          
          u_xlat0_d = u_xlat16_0 * _MainColor.w;
          
          out_f.SV_TARGET0.w = u_xlat0_d;
          
          u_xlat16_1.xyz = in_f.vs_INTERP0.xyz + float3(1.0, 1.0, 1.0);
