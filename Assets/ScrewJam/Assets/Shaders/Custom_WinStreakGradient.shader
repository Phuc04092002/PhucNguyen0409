Shader "Custom/WinStreakGradient"
{
  Properties
  {
    [PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
    _LerpStart ("LerpStart", float) = 0
    _LerpAmount ("LerpAmount", float) = 0
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Default
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = _LerpAmount * in_f.texcoord.y + _LerpStart;
          
          u_xlat1_d = _StartColor + (-_EndColor);
          
          u_xlat0_d = u_xlat0_d.xxxx * u_xlat1_d + _EndColor;
